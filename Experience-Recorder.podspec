...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  s.homepage         = "https://github.com/cleberhenriques/Experience-Recorder"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Cleber Henriques" => "cleberhenriques@gmail.com" }
  s.source           = { :git => "https://github.com/cleberhenriques/Experience-Recorder.git", :tag => s.version.to_s }
